  ...
  <div class="flex h-screen flex-col overflow-hidden text-foreground">
    ...
    <div class="app-shell-scroll-region min-h-0 flex flex-1 flex-col overflow-y-auto overflow-x-hidden overscroll-y-none">
      <div class="relative flex items-stretch">
        <aside
          v-if="isAccountRoute"
          class="block shrink-0 self-stretch border-r border-black/8 bg-white/70 text-neutral-600 transition-[width] duration-200 dark:border-white/[0.08] dark:bg-black/70 dark:text-[#A3A3A3]"

...
| Complete hackathon | `POST /api/hackathons/:hackathonId/actions/complete` | hackathon admin or platform admin | Allowed only after winners are announced. Reveals the completed winners showcase and enqueues winner emails for frozen prize-eligible members of winning teams. |

...
function buildFixtureSql(personas: ProvisionedStablePersona[]) {
  ...
  return [
    ...
    `insert into hackathons (
      ...
      state, max_team_members, require_x_profile, require_linkedin_profile, require_github_profile, require_luma_profile,
    ...
    (
      ...
      'participant-profile-requirement-fixture-hackathon',
      'Registration-open fixture that requires Luma username completion before applying.',
      null,
      null,
      'Vienna',

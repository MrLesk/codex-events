Feature: Admin operations application review flow
  Hackathon admins can review submitted participant applications and record approval outcomes from the admin operations workspace.
  ...
  Scenario: Hackathon admin reviews and approves a submitted participant application
    ...
    Then I should see the admin operations text "Admin Operations"
